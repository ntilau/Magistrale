...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{FEMproblem}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=14cm,keepaspectratio]{FullRadModel}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=14cm,keepaspectratio]{HFSS3x5Mesh}
\caption{Resulting mesh of the 3 by 5 patch antennas array.}
\label{fig:HFSS3x5Mesh}
\end{figure}
\begin{figure}[hbpt!]
\centering
\includegraphics[width=14cm,keepaspectratio]{HFSS3x5MeshFull}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=14cm,keepaspectratio]{HFSS3x5arraySMPL}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=14cm,keepaspectratio]{HFSS3x5pattern}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{patchPatternBS}
...
\end{figure} The total relative error introduced by the model order reduction is numerically null ($3.395 \ 10^{-13}$). There are some differences between the pattern computed by HFSS and ours. This is mainly due to the fact that our sampling points are distant from the radiation boundaries from which HFSS computes the far-field patterns. In effect, as we chose sampling points slightly distant from the radiation boundaries (1mm close to the surface), we notice a higher similitude of our pattern with HFSS's one, as shown in figure \ref{fig:patchPatternBSnearABC}.
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{patchPatternBSnearABC}
...
\centering
\includegraphics[width=7.3cm,keepaspectratio]{patchPatternNextBS}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{dual3phi}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{linCombError}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{spirHeltraj}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{spirHelErrorSVD}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{spirHeltraj17}
...
\par Finally, we can compute the radiation solid with the ROM of order 15. To scan the whole space, we have chosen cut-planes in the range $\phi \in [0\ensuremath{^\circ},180\ensuremath{^\circ})$ with a $\Delta \phi \approx 3\ensuremath{^\circ}$, while the sampled trigonometric polynomials matrix $\mat t$ covers the range $[0\ensuremath{^\circ}, 360\ensuremath{^\circ})$. The total ROM occupies only 3.2 MB of memory, and each new scan angle pattern is computed with the sampling resolution accuracy of $\approx 2 \ 10^{-3}$ in about 0.07 seconds on a dual core 2 GHz machine, while the full model requires 0.55 seconds for each scan angle.

\begin{figure}[hbpt!]
\centering
\includegraphics[width=14cm,keepaspectratio]{RadSolid}
\caption{Radiation directivity pattern scanning in $(\theta_x=-10\ensuremath{^\circ}, \theta_y=45\ensuremath{^\circ})$ computed by the reduced order model.}
\label{fig:RadSolid}
\end{figure}
...
\begin{figure}[bpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{vivaldiError}
...
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{vivaldiErrorOrder5}
\caption{Error introduced by a ROM of order 5 for several tested angles.}
\label{fig:vivaldiErrorOrder5}
\end{figure} Figure \ref{fig:vivaldiErrorOrder5} reports the error for several tested angles, the scan angles selected to span the projection space being of $\theta_x = 0\ensuremath{^\circ}, 22.5\ensuremath{^\circ}, 45\ensuremath{^\circ}, 67.5\ensuremath{^\circ}, 90\ensuremath{^\circ}$. This results in the fact we need much less than 81 spanning scan angles to scan the whole septentrional hemisphere. Figures \ref{fig:vivaldi3dError} and \ref{fig:vivaldi3dErrorZoom} show that only 40 vectors (the total number of antennas) are required to build an accurate ROM for three-dimensional beam steering of the tapered slot antennas array designed.

\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{vivaldi3dError}
\caption{Error for several orders of ROM able to scan the whole three-dimensional space.}
\label{fig:vivaldi3dError}
\end{figure}
\begin{figure}[hbpt!]
\centering
\includegraphics[width=12cm,keepaspectratio]{vivaldi3dErrorZoom}
