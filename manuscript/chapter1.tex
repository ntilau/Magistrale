...
\end{eqnarray}
where $\hat{\mbfit{n}}$ is the unit vector normal to the surface, inwardly directed to the first region, $\mbfit{J}_s$ and $\rho_s$ the \itt{electric surface current density} in $\mrm{[\nicefrac{\mrm A}{m}]}$ and \itt{electric surface charge density} in $\mrm{[\nicefrac{\mrm C}{m^2}]}$. %By (\ref{eq:conte1}-\ref{eq:contb1}), we obtain surface current and charge densities that keep information on the fields outside (region 2) of the region in which the Maxwell's equations are solved (region 1), as if the whole domain were unbounded.
...
Although there is no physical proof of existence of magnetic monopoles, the symmetrized form of this new set of equations governing the electromagnetic phenomena represents, as we will see, a powerful tool for the near fields to far fields transformations. In effect, it will be possible to invoke the fields extinction outside of the domain investigated, letting the surface currents and charges keep all the necessary information on the fields annihilated in such a way out of the domain.
...
\begin{figure}[ht!]
\centering
\includegraphics[width=8cm,keepaspectratio]{EMProblem}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=5cm,keepaspectratio]{EMNF}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=5cm,keepaspectratio]{EMNF2FF}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=10cm,keepaspectratio]{SphereNF2FF}
...
\par We present the results obtained from a Matlab implementation that computes the pattern from planar array of 3 by 5 point sources ($N = 15$ point sources), the first disposed along the $x$ direction and the latter along $y$. The point sources or array elements are chosen to be equally spaced of $\nicefrac{\lambda}{2}$. Due to power normalization, the maximum gain the array can achieve, which is actually the \itt{directivity} as the point sources are located in a lossless medium, is given by the total number of point sources, that is $10 \ \log_{10}(N) \approx 11.76 \ \mrm{dB}$ \cite{SelleriETA}.
...
\begin{figure}[ht!]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph3x5}
...
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph3x5_Phi0_0_0}
...
\begin{figure}[!bp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph3x5_Phi90_0_0}
...
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph_error}
...
\par As we can see in figures \ref{fig:sph3x5_Phi0_0_0} and \ref{fig:sph3x5_Phi90_0_0}, the sampling resolution of $\nicefrac{\lambda}{10}$ with an error of $\varepsilonup_{[\nicefrac{\lambda}{10}]} = 2.398 \ 10^{-3}$ for 181 \itt{look angles} ($\Delta \theta_r = 1$\ensuremath{^\circ}), that is the far zone directions in which $\tilde{\psi}_{r \ \mrm{N2F}}^*$ and $\tilde{\psi}_{r \ \mrm{Direct}}^*$ are computed, provides a pattern that can be considered reasonably accurate. As we can see in figure \ref{fig:sph_dTerror}, the number of look angles chosen does not significantly modify the error order even if the pattern is coarsely sampled (low number of look angles). However, there is a converging behavior while increasing the pattern sampling resolution ($\Delta \theta_r \rightarrow 0$).
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph_dTerror}
...
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph3x5_Phi90_0_0_lambda3}
...
\end{eqnarray}
Figures \ref{fig:sph3x5_Phi0_10_30} and \ref{fig:sph3x5_Phi90_10_30} show the patterns on the cut planes XZ and YZ resulting from the steering operation of $\theta_x=10$\ensuremath{^\circ} \ and $\theta_y=30$\ensuremath{^\circ}.
\begin{figure}[!htbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph3x5_Phi0_10_30}
\caption{Pattern computed on the $\phi=0$\ensuremath{^\circ} \ cut plane with $\nicefrac{\lambda}{10}$ sampling resolution and scan angles $\theta_x=10$\ensuremath{^\circ} \ and $\theta_y=30$\ensuremath{^\circ}.}
\label{fig:sph3x5_Phi0_10_30}
\end{figure}
\begin{figure}[!htbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{sph3x5_Phi90_10_30}
\caption{Pattern computed on the $\phi=90$\ensuremath{^\circ} \ cut plane with $\nicefrac{\lambda}{10}$ sampling resolution and scan angles $\theta_x=10$\ensuremath{^\circ} \ and $\theta_y=30$\ensuremath{^\circ}.}
...
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{box3x5}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=14cm,keepaspectratio]{sphboxSampling}
...
\begin{figure}[!hbtp]
\centering
\includegraphics[width=10cm,keepaspectratio]{boxFields}
...
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{planes3x5_Phi0_0_0_ext25}
\caption{Pattern computed from the top and bottom faces of the box on the $\phi=0$\ensuremath{^\circ} \ cut plane ($\nicefrac{\lambda}{10}$ sampling resolution).}
\label{fig:planes3x5_Phi0_0_0_ext25}
\end{figure}
\begin{figure}[!tbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{planes3x5_Phi90_0_0_ext25}
\caption{Pattern computed from the top and bottom faces of the box on the $\phi=90$\ensuremath{^\circ} \ cut plane ($\nicefrac{\lambda}{10}$ sampling resolution).}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{boxNFvector}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{FEKOgeom}
...
\centering
\includegraphics[width=7.3cm,keepaspectratio]{FEKOphi0}
\caption{Pattern computed with FEKO on the $\phi=0$\ensuremath{^\circ} \ cut plane.}
\label{fig:FEKOPhi0}
\end{minipage}
\hspace{0.1cm} % To get a little bit of space between the figures
\begin{minipage}[b]{0.5\linewidth}
\centering
\includegraphics[width=7.3cm,keepaspectratio]{FEKOphi90}
\caption{Pattern computed with FEKO on the $\phi=90$\ensuremath{^\circ} \ cut plane.}
\label{fig:FEKOPhi90}
\end{minipage}
\end{figure}
\begin{figure}[!htbp]
\centering
\includegraphics[width=12cm,keepaspectratio]{box3x5_0_0}
...
\begin{minipage}[b]{0.5\linewidth}
\centering
\includegraphics[width=7.3cm,keepaspectratio]{box3x5_0_0_1}
...
\begin{minipage}[b]{0.5\linewidth}
\centering
\includegraphics[width=7.3cm,keepaspectratio]{box3x5_0_0_2}
...
\begin{figure}[!t]
\centering
\includegraphics[width=12cm,keepaspectratio]{boxSamplingVect}
